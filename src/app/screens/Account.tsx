    ...
    <SafeContainer>
      <View className="flex-1 px-8">
        <Text
          ...
          className="mb-8 text-center text-4xl font-outfit-bold text-foreground"
        >
          Account
        </Text>
        <Text className="mb-8 text-center text-xl font-outfit-medium text-muted-foreground">
          Manage your account settings
        </Text>

        <View className="mb-10 rounded-sm border border-border bg-card p-5">
          <Text className="mb-3 text-xl font-outfit-medium text-muted-foreground">
